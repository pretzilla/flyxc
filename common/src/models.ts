...
import { trackerPropNames, Trackers } from './live-track';
...
export class AccountFormModel extends ObjectModel<AccountModel> {
  ...
  readonly inreach = this.createTrackerModel(Trackers.Inreach);
  readonly spot = this.createTrackerModel(Trackers.Spot);
  readonly skylines = this.createTrackerModel(Trackers.Skylines);
  readonly flyme = this.createTrackerModel(Trackers.Flyme);

  private createTrackerModel(tracker: Trackers): TrackerFormModel {
...
export const trackerValidators: Readonly<Record<Trackers, Validator<TrackerModel>[]>> = {
  [Trackers.Inreach]: [new TrackerCallbackValidator('This InReach URL is invalid', validateInreachAccount)],
  [Trackers.Spot]: [new TrackerCallbackValidator('This Spot ID is invalid', validateSpotAccount)],
  [Trackers.Skylines]: [new TrackerCallbackValidator('This Skylines ID is invalid', validateSkylinesAccount)],
  [Trackers.Flyme]: [],
};
...
export const accountTransformers: Readonly<Record<Trackers, AccountTransformer>> = {
  [Trackers.Inreach]: noOpAccountTransformer,
  [Trackers.Spot]: noOpAccountTransformer,
  [Trackers.Skylines]: noOpAccountTransformer,
  [Trackers.Flyme]: accountWithServerIdTransformer,
};
