...
export const trackerPropNames: Readonly<Record<Trackers, string>> = {
  [Trackers.Inreach]: 'inreach',
  [Trackers.Spot]: 'spot',
  [Trackers.Skylines]: 'skylines',
  [Trackers.Flyme]: 'flyme',
};

// How to display the tracker name.
export const trackerDisplayNames: Readonly<Record<Trackers, string>> = {
  [Trackers.Inreach]: 'InReach',
  [Trackers.Spot]: 'Spot',
  [Trackers.Skylines]: 'Skylines',
  [Trackers.Flyme]: 'FlyMe',
...
export function getFixDevice(flags: number): Trackers {
