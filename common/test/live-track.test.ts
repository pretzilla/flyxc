  ...
  describe('track with common fixes', () => {
    it('should merge emergency', () => {
      const track1: LiveTrack = {
        ...
        lon: [21, 22, 23],
        alt: [31, 32, 33],
        flags: [Trackers.Inreach, Trackers.Inreach, Trackers.Inreach],
        extra: {
          0: { message: 'hello' },
          2: { speed: 10 },
        },
      ...
      const track2: LiveTrack = {
        ...
        lon: [0],
        alt: [0],
        flags: [Trackers.Spot | LiveTrackFlag.Emergency],
        extra: {
          0: { message: 'world' },
        },
      };
      ...
      expect(mergeLiveTracks(track1, track2)).toEqual({
        ...
        lon: [21, 22, 23],
        alt: [31, 32, 33],
        flags: [Trackers.Inreach, Trackers.Inreach | LiveTrackFlag.Emergency, Trackers.Inreach],
        extra: {
          0: { message: 'hello' },
          2: { speed: 10 },
          1: { message: 'world' },
    ...
    it('should merge low battery', () => {
      ...
      const track2: LiveTrack = {
        ...
        lon: [0],
        alt: [0],
        flags: [Trackers.Spot | LiveTrackFlag.LowBat],
        extra: {
          0: { message: 'world' },
        },
      };
      ...
      expect(mergeLiveTracks(track1, track2)).toEqual({
        ...
        lon: [21, 22, 23],
        alt: [31, 32, 33],
        flags: [Trackers.Inreach, Trackers.Inreach | LiveTrackFlag.LowBat, Trackers.Inreach],
        extra: {
          0: { message: 'hello' },
          2: { speed: 10 },
          1: { message: 'world' },
    ...
    it('should merge valid fixes first', () => {
      ...
      const track2: LiveTrack = {
        ...
        lon: [22],
        alt: [32],
        flags: [Trackers.Spot | LiveTrackFlag.Valid],
        extra: {
          0: { message: 'world' },
        },
      };
      ...
      expect(mergeLiveTracks(track1, track2)).toEqual({
        ...
        lon: [21, 22, 23],
        alt: [31, 32, 33],
        flags: [Trackers.Inreach, Trackers.Spot | LiveTrackFlag.Valid, Trackers.Inreach],
        extra: {
          0: { message: 'hello' },
          2: { speed: 10 },
          1: { message: 'world' },
    ...
    it('should merge extras', () => {
      const track1: LiveTrack = {
        ...
        alt: [31, 32, 33, 34],
        flags: [
          Trackers.Spot | LiveTrackFlag.Valid,
          Trackers.Spot | LiveTrackFlag.Valid,
          Trackers.Spot | LiveTrackFlag.Valid,
          Trackers.Spot | LiveTrackFlag.Valid,
        ],
