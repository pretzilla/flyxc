...
import { differentialEncodeLiveTrack, LiveTrackFlag, Trackers } from 'flyxc/common/src/live-track';
...
describe('Create GeoJSON features', () => {
  ...
  describe('Single segment', () => {
    ...
    it('should add points for emergency', () => {
      const track: LiveTrack = {
        ...
        flags: [
          Trackers.Flyme,
          Trackers.Flyme | LiveTrackFlag.Emergency,
          Trackers.Flyme,
          Trackers.Flyme,
          Trackers.Flyme,
          Trackers.Flyme,
  ...
  describe('Multiple segments', () => {
    const track: LiveTrack = {
      id: 123,
      timeSec: [1, 10, 20, 100, 140, 150, 260],
      lon: [11, 110, 120, 130, 140, 150, 160],
      lat: [21, 210, 220, 230, 240, 250, 260],
      alt: [31, 310, 320, 330, 340, 350, 360],
      flags: [
...
describe('Update libve tracks', () => {
  describe('Only current tracks', () => {
    it('should replace current tracks', () => {
      ...
      const updates: LiveDifferentialTrackGroup = {
